...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "ArticleSelling@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "ArticleSelling API";

        private String description = "ArticleSelling API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "ArticleSelling";
